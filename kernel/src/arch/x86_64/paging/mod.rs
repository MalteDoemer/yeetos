...
///
/// # Safety
/// This variable is initialized once during paging::init_once() and is immutable after that.
/// Thus, any read access to `INITIAL_P4_ADDR` after paging::init_once() has completed is safe.
...
/// during paging::init_once() and we allocate enough PDPT's to completely map the kernel's virtual
